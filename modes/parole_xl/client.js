...
function createRoom() {
    ...
    if (!nickname) {
        document.getElementById('create-error').innerText = t('wc_toast_nick_error') || "Insert a nickname before joining the game";
        return;
    }
    const lengths = [];
...
function joinRoom() {
    const nickname = document.getElementById('nickname').value.trim();
    if (!nickname) {
        document.getElementById('join-error').innerText = t('wc_toast_nick_error') || "Insert a nickname before joining the game";
        return;
    }
